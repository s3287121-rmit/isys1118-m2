...
import isys1118.group1.shared.FieldVerifier;
...
//		HTML hp0 = new HTML("<p>Test<p>");
//		Anchor hp1 = new Anchor("Google", "http://www.google.com");
//		vp.add(hp0);
//		vp.add(hp1);
//		menu.add(vp);
//		
...
//			@Override
//			public void onClick(ClickEvent event) {
//				menuService.getMenuOption("Test", new AsyncCallback<String>() {
//
//					@Override
//					public void onFailure(Throwable caught) {}
//
...
//						menu.clear();
//						VerticalPanel vp = new VerticalPanel();
//						HTML hp0 = new HTML("<p>Another one bites the dust<p>");
//						Anchor hp1 = new Anchor("Google", "http://www.google.com");
//						HTML hp2 = new HTML("<p>gsdhgfjds</p>");
//						vp.add(hp0);
//						vp.add(hp1);
//						vp.add(hp2);
//						menu.add(vp);
//
//						hp0.addClickHandler(new MenuClickHandler());
//					}
//					
//				});
//				
